...
| :--- | :---: | :---: |
| **PF0560** | Only observed on 30/06/2025 and location was recorded at GR11. | YES |
| **PF5665** | PE5665 exist and I think it was a typo (PF instead of PE) because PF5665 does not exist in the list and PE5665 was not recorded 07/07/2025 what PF5665 occurs. | NO (PE5665 -> PF5665) |
| **PE0131** | PF0131 exists and was not recorded on the same day as PE0131, probably a typo | NO (PE0131 -> PF0131) |
| **PF0251** | Only observed on the 19/06/2025. Comment says dead. | YES |
| **PE4507** | Only observed on the 19/06/2025. No matching PF-id. | YES |
| **PF3512** | Probably a mix up with PE3512 who was in the intensive survey | NO (PF3512 -> PE3512) |
| **PE2365** | Only observed on the 23/06/2025. | YES |
| **PD2945** | Probably a mix up with PE2945 (that was recorded for 4 days but not in the intensive survey list.) | YES |
...
| **PF0739** | Only observed on the 12/06/2025. | YES |
| **PF0697** | Only observed on the 07/07/2025. No PE or PE id exist. Checked all PF069* but they were recorded on the same date so no mix up with the last digit. | YES |
| **PE3570** | Only observed on the 19/06/2025. No PF-id observed. | YES |
